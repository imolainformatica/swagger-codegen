...
public abstract class PetApi extends ApiConfiguration {
    ...
    .type(Pet.class)
            ...
            .route().routeId("addPet").process(new PetApiValidator("addPet"));
    }
    ...
    .produces("application/xml,application/json")
            ...
            .param().name("apiKey").type(RestParamType.header).required(Boolean.FALSE).defaultValue("").description("").endParam()
            .responseMessage().code(400).message("Invalid pet value").endResponseMessage()

            .route().routeId("deletePet").process(new PetApiValidator("deletePet"));
    }
    ...
    .outType(Pet[].class)
            ...
            .route().routeId("findPetsByStatus").process(new PetApiValidator("findPetsByStatus"));
    }
    ...
    .outType(Pet[].class)
            ...
            .route().routeId("findPetsByTags").process(new PetApiValidator("findPetsByTags"));
    }
    ...
    .outType(Pet.class)
            ...
            .route().routeId("getPetById").process(new PetApiValidator("getPetById"));
    }
    ...
    .type(Pet.class)
            ...
            .route().routeId("updatePet").process(new PetApiValidator("updatePet"));
    }
    ...
    .consumes("application/x-www-form-urlencoded").produces("application/xml,application/json")
            ...
            .route().routeId("updatePetWithForm").process(new PetApiValidator("updatePetWithForm"));
    }
    ...
    .outType(ModelApiResponse.class)
            ...
            .route().routeId("uploadFile").process(new PetApiValidator("uploadFile"));
    }
